...
- **28 Sep – 1 Oct, Sweden:** four trail days on the eastern TET corridor — S-07 from the
  Sundsvall hotel door, S-06 driven against its numbering, S-16 to Hakkas — via Docksta
  (12 km off the line at Ullånger), Granö Beckasin and Treehotel to the ICEHOTEL. **882 km of trail.**
...
- **17 Oct:** a transit night at Lentiira, added so that Ruka → Koli becomes two gravel
  days instead of one 439-km road day.
...
Built 7 Sep 2026 · last updated 16 Sep 2026 (28 Sep night moved to Docksta; Navigation files v4).
