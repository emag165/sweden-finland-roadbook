...
- **28 Sep – 1 Oct, Sweden:** the **paved route is the plan** — E4 to Docksta, E4 · 353 · E12 to
  Granö, 363 · 364 · E4 · 97 to Treehotel, 97 · E10 to the ICEHOTEL (116 · 191 · 340 · 279 km) —
  and the eastern TET corridor is the **alternative, chosen at breakfast**: S-07 from the Sundsvall
  hotel door, S-06 driven against its numbering, S-16 to Hakkas, **882 km of trail** in four options
  (from 17 Sep; until then the trail days were the plan).
...
- Sources behind the activity claims: `analysis/Base_Activities_Verified_v1.1.md`.
  ...
  the map verification: `analysis/Map_Verification_v1.4.md`. Navigation files (GPX per day for
  Gaia, KML for Google My Maps) are in `Navigation/`.

Built 7 Sep 2026 · last updated 17 Sep 2026 (Sweden paved-first; Codex review corrections; Navigation files v5).
